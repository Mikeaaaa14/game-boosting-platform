...
<template>
  ...
  >
    ...
    <div v-if="!messages.length" class="empty-panel !py-12">
      {{ emptyText }}
    </div>
    ...
    <div v-else class="space-y-4">
      <div
        ...
        :class="{
          'rounded-[28px] ring-1 ring-primary-300/40 shadow-[0_0_24px_rgba(0,240,255,0.15)]': Number(highlightedMessageId) === Number(message.id),
        }"
      >
        <ChatMessageBubble
          :message="message"
