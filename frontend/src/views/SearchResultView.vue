...
<template>
  <div class="page-shell space-y-8">
    ...
    <div v-if="searchStore.loading" class="surface-card flex items-center justify-center py-20">
    ...
    <section v-else class="empty-panel">
      <h2 class="text-2xl font-semibold text-white">没有找到匹配结果</h2>
      <p class="mt-3 text-sm leading-7 text-slate-400">
        试着换一个关键词，或者放宽筛选条件再搜索一次。
      </p>
    </section>
