...
class ConversationParticipantResponse(BaseModel):
    ...
    last_read_message_id: Optional[int] = Field(default=None, description="最后已读消息ID")
    last_read_at: Optional[datetime] = Field(default=None, description="最后已读时间")
...
class ConversationOrderBrief(BaseModel):
    ...
    booster_id: Optional[int] = Field(default=None, description="接单代练ID")
...
class ConversationResponse(BaseModel):
    ...
    last_message_preview: Optional[str] = Field(default=None, description="最后消息预览")
    ...
    order: Optional[ConversationOrderBrief] = Field(default=None, description="关联订单摘要")
...
class ChatMessageResponse(BaseModel):
    ...
    created_at: datetime = Field(description="创建时间")
    recalled_at: Optional[datetime] = Field(default=None, description="撤回时间")
    meta_json: Optional[dict[str, Any]] = Field(default=None, description="附加元数据")
    sender: Optional[ChatUserBrief] = Field(default=None, description="发送者信息")
